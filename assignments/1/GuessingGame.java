...
public class GuessingGame {
  ...
  static enum gameChoice {NONE, USER_GUESSES, COMP_GUESSES}
  ...
  private static void chooseGame() {
    ...
    currentGameChoice = gameChoice.values()[chooseOption(
      new String[] {
  ...
  private static void guessNumber() {
    switch (currentGameChoice){
      case USER_GUESSES:
        ...
        currentGuess = getInteger(lowestPossible, highestPossible);
      case COMP_GUESSES:
  ...
  private static void showGuessStats() {
    out.format("Correct! That took %d tries.%n", currentNumberTries);
  }
